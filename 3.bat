@echo off
title CLEANER FOR ALL GAMES MADE BY HAKO
color C
@ ECHO.
@ ECHO.~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~ Cleaner FOR ALL GAMES (--VX.GG--) ~~~~~~~~~~~~~~~~~~~~~~~~~~~
@ ECHO.
...
@ ECHO.
echo  		Continue reading the instructions manual to successfully spoof your hardware*
@ ECHO.
@ ECHO.
echo. & pause
