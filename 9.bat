@echo off
::idk its just a bunch of old cleaners from different games pasted together to make a big cleaner that works and should work for a long time since it has alot of random tracer files from diff games.
title VX.GG
color F0
